...
// Blog-related imports — re-enable alongside the toggle below when blog is turned back on.
...
export function LatestPosts({
    ...
    <div className="space-y-4 divide-y divide-gray-200 dark:divide-gray-700 md:mt-8 md:space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-end text-base font-medium leading-6">
          <Link href="/snippets" aria-label="All snippets">
            <GrowingUnderline data-umami-event="all-snippets">
              <span className="hidden md:inline-block">View all snippets</span>
  ...
  /* Original posts/snippets toggle — restore this to bring back the blog feed on the homepage.
  return (
    <div className="space-y-4 divide-y divide-gray-200 dark:divide-gray-700 md:mt-8 md:space-y-8">
      <div className="flex items-center justify-between">
        <div className="flex text-2xl font-bold sm:text-2xl sm:leading-10 md:text-4xl">
