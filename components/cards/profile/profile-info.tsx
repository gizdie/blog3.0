...
export function ProfileCardInfo() {
  return (
    <div className="hidden py-4 md:block md:px-5">
      <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Rusty Yow</h3>
      <h5 className="py-2 text-gray-500 dark:text-gray-400">Tech Nerd</h5>
